...
#HM_OTH_DSET = 'hm_reference_allele'
...
#              HM_EFFECT_DSET: str, HM_OTH_DSET: str, HM_FREQ_DSET: float, HM_SNP_DSET: str}
...
#TO_DISPLAY_RAW = {SNP_DSET, CHR_DSET, BP_DSET, EFFECT_DSET, OTH_DSET, EFFECT_WEIGHT_DSET, FREQ_DSET, OR_DSET, HR_DSET, BETA_DSET,}


#TO_LOAD_DSET_HEADERS_DEFAULT = {SNP_DSET, CHR_DSET, BP_DSET, EFFECT_DSET, OTH_DSET, EFFECT_WEIGHT_DSET,
#                                FREQ_DSET, OR_DSET, HR_DSET, BETA_DSET}

#TO_STORE_DSETS_DEFAULT = {SNP_DSET, CHR_DSET, BP_DSET, EFFECT_DSET, OTH_DSET,  EFFECT_WEIGHT_DSET,
#                          FREQ_DSET, OR_DSET, HR_DSET, BETA_DSET}

#TO_QUERY_DSETS_DEFAULT = {SNP_DSET, CHR_DSET, BP_DSET, EFFECT_DSET, OTH_DSET, FREQ_DSET}

#TO_INDEX = {BP_DSET}

#REQUIRED = {CHR_DSET, SNP_DSET, EFFECT_DSET, OTH_DSET, EFFECT_WEIGHT_DSET}
