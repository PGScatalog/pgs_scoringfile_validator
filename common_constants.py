...
DSET_TYPES = {SNP_DSET: str, CHR_DSET: str, BP_DSET: int, EFFECT_DSET: str, REF_DSET: str,
              EFFECT_WEIGHT_DSET: float, WEIGHT_DSET:str, LOCUS_DSET: str, OR_DSET: float, HR_DSET: float, BETA_DSET: float, FREQ_DSET: float,
...
TO_DISPLAY_ORDER = [ SNP_DSET, CHR_DSET, BP_DSET, EFFECT_DSET, REF_DSET, EFFECT_WEIGHT_DSET, WEIGHT_DSET, LOCUS_DSET, FREQ_DSET, OR_DSET, HR_DSET, BETA_DSET]
